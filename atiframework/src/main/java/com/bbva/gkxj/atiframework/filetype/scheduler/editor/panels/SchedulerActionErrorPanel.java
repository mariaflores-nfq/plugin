...
/**
 * Panel principal para la gestión de la sección "Action on Error" (Batch y Queries) del Scheduler.
 *
 * Extiende {@link ActionPanel} y proporciona la clave raíz JSON utilizada
 * para serializar/deserializar la sección de errores de tipo "batchError".
 */
public class SchedulerActionErrorPanel extends ActionPanel {
     ...
     */
    public SchedulerActionErrorPanel(@NotNull Project project, @NotNull VirtualFile file) {
        super(project, file);
    }
     ...
     *
     * @return la clave raíz JSON utilizada por el panel ("batchError")
     */
    @Override
