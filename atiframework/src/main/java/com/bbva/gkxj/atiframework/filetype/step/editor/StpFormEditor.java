...
import com.bbva.gkxj.atiframework.filetype.step.editor.panels.StepBodyPanel;
...
/**
 * Editor de formulario para ficheros de tipo step.
 *
 ...
 */
public class StpFormEditor extends UserDataHolderBase implements FileEditor {

        private final Project myProject;
        private final Document myDocument;
        private final VirtualFile myFile;
        private JsonObject jsonObject;
        private StepBodyPanel stpMainPanel;
        /**
        ...
        /**
         * Listeners para sincronizar cambios entre texto y formulario
         */
         ...
         */
        public StpFormEditor(@NotNull Project project, @NotNull VirtualFile file) {
        ...
        private void createUIComponents() {
            this.stpMainPanel = new StepBodyPanel(myProject, myFile);
            addFieldListeners();
        }
        ...
        public void updateForm() {
            ...
            try {
                this.jsonObject = createJsonObjectFromDocument(this.myDocument);
                this.stpMainPanel.updateForm(this.jsonObject);
            } finally {
                updating = false;
            }
         ...
         * y escribe el resultado en el documento de IntelliJ.
         *
         * Si updating es true, la llamada se ignora para evitar recursividad.
         */
        private void updateDocument() {
            ...
            try {
                this.jsonObject = createJsonObjectFromDocument(this.myDocument);
                this.stpMainPanel.updateDocument(this.jsonObject);
        ...
        public @Nullable JComponent getPreferredFocusedComponent() {
            return this.stpMainPanel.getPreferredFocusedComponent();
        }
        ...
        private void addFieldListeners() {
            ...
            this.stpMainPanel.addFieldListeners(textListener, actionListener, changeListener);
        }
